...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.add_new_tab(QUrl("https://udm14.com/"), "homepage")
        self.show()
        self.setWindowTitle("Cat Web Browser")

    def add_new_tab(self, qurl=None, label="Blank"):
        if qurl is None:
            qurl = QUrl("https://udm14.com/")
    ...
    #     self.setWindowTitle(f"{title} - Cat Web Browser")
...
app.setApplicationName("Cat Web Browser")
window = MainWindow()
app.exec_()
